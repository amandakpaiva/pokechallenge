...
//      Use of ternary expressions to define button appearance
        ...
        DispatchQueue.main.async {
            ...
            let boldName = NSMutableAttributedString(string: "Nome: ", attributes: boldAttribute)
            ...
            let boldType = NSMutableAttributedString(string: "Tipo: ", attributes: boldAttribute)
